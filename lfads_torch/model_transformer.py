...
class LFADSTransformer(pl.LightningModule):
    def __init__(
        ...
        """
        Initialize the LFADS model with a Transformer encoder.
        ...
        # Create the transformer encoder and decoder
